...
def run_react_agent(user_query: str, provider, mcp_server: MCPAcademicServer) -> list:
    ...
    while step < MAX_ITERATIONS:
        ...
        llm_response = provider.generate_with_tools(full_prompt, tools_list, system_prompt=REACT_AGENT_SYSTEM_PROMPT)
        ...
        if llm_response.get("type") == "text":
            ...
            print(f"🔄 Tiếp tục vòng lặp — đã lưu Observation vào ngữ cảnh.\n")
...
if __name__ == "__main__":
    ...
    if "--interactive" in sys.argv:
        ...
        print("   - Tra cứu IoT: 'Kiểm tra trạng thái nhiệt độ DHT22 trên thiết bị ESP32-WROOM'")
        print("   - Đặt lịch tư vấn: 'Đặt lịch hẹn tư vấn về hệ thống tưới tự động cho thiết bị DEV0000001'")
